  ...
  return (
    <div className='flex flex-col gap-[0.62rem]'>
      ...
      <div className='border border-solid border-bordergrey rounded-lg'>
        <div className='p-[0.94rem] flex gap-[0.32rem] flex-wrap'>
          <div className='flex items-center py-[0.38rem] px-2 paratext rounded-[1.375rem] bg-[#DDEDFF] w-fit'>
            UI/UX and Design <span className='placecenter'><Image src="/cut.svg" alt='close' width={24} height={24} /></span>
          </div>
        </div>
