...
const List = () => {
  return (
    <div className='p-[0.88rem] border border-solid border-bordergrey rounded-xl lg:p-4 lg:card'>
      <div className='flex justify-between'>
        <div className='flex max-lg:items-center gap-[0.62rem] lg:flex-col'>
          ...
          <div className='flex flex-col'>
            ...
            <div className="flex items-center">
              ...
              <div className='border-r border-bordergrey h-full m-[0.31rem] lg:m-[0.62rem]' />
      ...
      <div className='border border-dotted my-[0.62rem] lg:my-4' />
      <div className='flex justify-between items-center'>
        <div className='flex gap-[0.62rem]'>
          <div>
            <div className='paratext font-semibold'>00</div>
            <div className='text-[0.63rem] lg:text-xs font-medium text-darkblue'>Duration</div>
          </div>
          <div>
            <div className='paratext font-semibold'>00</div>
            <div className='text-[0.63rem] lg:text-xs font-medium text-darkblue'>Questions</div>
          </div>
        </div>
